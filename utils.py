...
# inputs (single)
file_dic_Report = input("input file_dic for Report: ")
file_dic_Master = input("input file_dic for Master: ")
file_dic_Master_pre = input("input file_dic for Previous Master: ")
file_dic_Dashboard = input("input file_dic for Dashboard: ")
Input_date = input("Enter Date for DEV/UAT/PROD: ")

# inputs (multi)
file_dic_Master_1 = input("input file_dic for Master 1: ")
file_dic_Master_2 = input("input file_dic for Master 2: ")
file_dic_Master_3 = input("input file_dic for Master 3: ")
file_dic_Master_4 = input("input file_dic for Master 4: ")
file_dic_Master_5 = input("input file_dic for Master 5: ")
